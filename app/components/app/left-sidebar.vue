...
interface Props {
  open: boolean;
  // SidebarProps에서 가져온 타입을 명시적으로 지정
  variant?: SidebarProps['variant']; // sidebar, flating, inset
  collapsible?: SidebarProps['collapsible']; // offcanvas, icon, none
  side?: SidebarProps['side']; // right, left
};

// interface Props {
//   open: boolean;
//   variant?: 'sidebar' | 'ghost' | 'floating';
